...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile6`, function (sprite, location) {
    mySprite.sayText("he sad :(", 1000, true)
})
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile4`, function (sprite, location) {
    mySprite.sayText("spikes and water kill you", 1000, true)
})
controller.combos.attachCombo("up up down down left right left right b a", function () {
    game.setGameOverMessage(true, "lol")
    game.gameOver(true)
})
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`happy bob`, function (sprite, location) {
    tiles.setCurrentTilemap(tilemap`level3`)
    tiles.placeOnTile(mySprite, tiles.getTileLocation(3, 12))
    mySprite2 = sprites.create(assets.image`evil bob`, SpriteKind.Enemy)
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`sad bob`, function (sprite, location) {
